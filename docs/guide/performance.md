...
The current v1.8.0 generated-binding evidence measures a field-heavy typed route: 30 query values, compiled validation, and an exact 30-field JSON response. At the four-worker profile, Kruda delivered 533,210 req/s versus Fiber v3.5.0 at 259,170 req/s (2.06x), while Kruda and Actix Web v4.15.0 remained in the same throughput range. At a matched 129,000 req/s, Kruda's corrected p99 was 1.970 ms versus Fiber's 3.090 ms. See the [full conditions and limits](/benchmarks/2026-09-21-v1.8.0-typed-binding).

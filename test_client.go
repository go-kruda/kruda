...
// Result returns the standard *http.Response generated by the recorder.
// This is useful for inspecting cookies, trailers, and other fields
// that are not directly exposed by TestResponse helper methods.
// Callers should close the response body when done:
//
//	resp := tr.Result()
//	defer resp.Body.Close()
func (tr *TestResponse) Result() *http.Response {
	return tr.recorder.Result()
}
